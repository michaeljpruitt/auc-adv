--[[
	...
	Revision: $Id: GathererNodeSearch.lua 927 2011-10-05 01:25:05Z kjasi $
...
Gatherer_RegisterRevision("$URL: http://svn.norganna.org/gatherer/trunk/Gatherer/GathererNodeSearch.lua $", "$Rev: 927 $")
		...
		for continent = start, finish do
			for _, zone in Gatherer.Storage.GetAreaIndices(continent) do
				if Gatherer.Storage.IsGatherInZone( continent, zone, gatherName, gType ) then
					...
					local archfinds, treasures, herbs, ores = Gatherer.Storage.GetNodeCountsByGatherType( continent, zone )
