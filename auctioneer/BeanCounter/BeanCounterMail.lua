--[[
	...
	Revision: $Id: BeanCounterMail.lua 5263 2012-01-07 23:45:03Z kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/BeanCounterMail.lua $","$Rev: 5263 $","5.1.DEV.", 'auctioneer', 'libs')
