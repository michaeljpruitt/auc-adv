--[[
	...
	Revision: $Id: BeanCounterConfig.lua 5267 2012-01-22 18:33:58Z kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/BeanCounterConfig.lua $","$Rev: 5267 $","5.1.DEV.", 'auctioneer', 'libs')
