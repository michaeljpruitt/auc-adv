--[[
	...
	Revision: $Id: BeanCounter.lua 5266 2012-01-12 03:33:30Z kandoko $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/BeanCounter/BeanCounter.lua $","$Rev: 5266 $","5.1.DEV.", 'auctioneer', 'libs')
