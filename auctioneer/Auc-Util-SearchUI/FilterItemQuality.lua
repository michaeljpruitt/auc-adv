--[[
	...
	Revision: $Id: FilterItemQuality.lua 5229 2011-11-03 13:10:05Z brykrys $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Util-SearchUI/FilterItemQuality.lua $", "$Rev: 5229 $")
