--[[
	...
	Revision: $Id: BasicFilter.lua 5219 2011-09-07 12:22:39Z brykrys $
...
AucAdvanced.RegisterRevision("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Filter-Basic/BasicFilter.lua $", "$Rev: 5219 $")
