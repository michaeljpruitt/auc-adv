--[[
	AuctioneerDB
	Revision: $Id: DbCore.lua 4828 2010-07-21 22:20:18Z Prowell $
	Version: <%version%>
...
--]]
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/auctioneer/trunk/Auc-Db/DbCore.lua $","$Rev: 4828 $","5.1.DEV.", 'auctioneer', 'libs')
