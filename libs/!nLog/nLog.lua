--[[
	...
	Revision: $Id: nLog.lua 292 2010-11-07 22:36:40Z Prowell $
...
LibStub("LibRevision"):Set("$URL: http://svn.norganna.org/libs/trunk/!nLog/nLog.lua $","$Rev: 292 $","5.1.DEV.", 'auctioneer', 'libs')
